...
public class Tester {
	...
	public static void main(String[] args) throws IOException {
		...
		String rf1File = "covidSequenceRF1.csv";
		String rf2File = "covidSequenceRF2.csv";
		String rf3File = "covidSequenceRF3.csv";
		String delimiter = ",";
		String[] rfCodons = {};
	 ...
	 * @param list 		the array list of amino acids
	 * @param sequence	the genetic sequence being sent to calcCodonRF in this method
	 * @param rfNum		the 
	...
	public static void codonBiasRFReport(ArrayList<AminoAcid> list, String[] sequence, int rfNum) throws IOException {
		...
		switch(rfNum) {
		case 1: 
			outFileName = "covidCodonBiasRF1.txt";
			break;
		case 2:
			outFileName = "covidCodonBiasRF2.txt";
			break;
		case 3:
			outFileName = "covidCodonBiasRF3.txt";
			break;
		}
	...
	/**
	 * This method will display the codon bias of an amino acid 
	 * @param letter	the letter sent to find amino acid
	 * @param list 		the amino acid list 
	 * @param sequence 	the genetic sequence being passed to calcCodonRF in this method
	 * @author Brooke Pottle
	 */
	...
	/**
	 * This method will read a sequence file and store the codons in an array
	 * @param rfFile 	the sequence file for the specific rf 
	 * @return codons	the array of codons from the genetic sequence
	 * @throws IOException	if file is not found
	 * @author Brooke Pottle
	 */
	...
	/**
	 * 3.A This will calculate how many times each codon from acid appears
	 * @param acid 		the amino acid that is being passed
	 * @param sequence 	the array of codons for the genetic sequence 
	 * @return count 	the array of counts for each codon found from the acid
	 * @author Brooke Pottle
	 */
